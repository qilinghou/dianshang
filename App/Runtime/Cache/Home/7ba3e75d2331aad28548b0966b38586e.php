  ...
  <div class="blank"></div>
   <div style="width:1000px;margin-left:10px;">
    ...
    <table border="1" bordercolor='green' width="98%" align="center">
        ...
        <tbody> 
        <?php if(is_array($goodscollect)): foreach($goodscollect as $key=>$goodscollect): ?><tr align='center'>
                <td><?php echo ($goodscollect["id"]); ?></td>             
                <td>
                    <a href="<?php echo U('Goods/index',array('id'=>$goodscollect['gid']));?>">
                    	<font style="font-size:15px;color:red;"><?php echo ($goodscollect["goodsname"]); ?></font>
                    </a>
                </td>
                <td><?php echo (date("Y-m-d H:i:s",$goodscollect["collecttime"])); ?></td>
                <td><a href="<?php echo U('MyCollect/collectDel',array(id=>$goodscollect['id']));?>">删除</a></td>
