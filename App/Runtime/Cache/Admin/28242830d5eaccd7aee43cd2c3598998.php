        ...
        <div id="mws-container" class="clearfix">
            ...
            <div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                        <form class="mws-form" action="/tongmeng/admin.php/Bulletin/update" method="post">
                            <div class="mws-form-inline">
                                <div class="mws-form-row">
                                    <label class="mws-form-label">标题:</label>
                                    <div class="mws-form-item">
                                        <input type="text" class="small" name="title" value="<?php echo ($bullentins['title']); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <input type="text" class="small" name="btime" value="<?php echo ($bullentins['btime']); ?>">
                                    </div>
                                </div>
                                 ...
                                 <div class="mws-form-row">
                                   ...
                                   <div class="mws-form-item">
                                       ...
                                       <textarea class="small" name="content" autofocus><?php echo ($bullentins['content']); ?></textarea>
                                   </div>
                                </div>

                            </div>
                            <div class="mws-button-row">
                            	<input type="hidden" name="id" value="<?php echo ($bullentins['id']); ?>">
