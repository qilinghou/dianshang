           ...
           <form action="<?php echo U('User/personalUpdate');?>" method="post" enctype="multipart/form-data" align="center" >
              <div >
                  <div  style="margin-left:220px;">
                      用户昵称:
                      <input type="text" class="small" name="name" value="<?php echo ($userdetail['name']); ?>"><span>用户昵称的长度为1-20个字节</span>
                  </div><br/>
                  ...
                  <div style="margin-left:100px;" id="extend_field5i">
                      手机号码:&nbsp;
                      <input type="text" name="tel" value="<?php echo ($userdetail['tel']); ?>"  class="inputBg">
