             ...
             <div class="mws-panel grid_8 mws-collapsible">
                    ...
                    <div class="mws-panel-body no-padding dataTables_wrapper" style="background: none repeat scroll 0 0 #444444;">
                        <table class="mws-table mws-datatable">
                            ...
                            <tbody> 
                            <?php if(is_array($jobs)): foreach($jobs as $key=>$job): ?><tr align='center'>
                                    <td><?php echo ($job["id"]); ?></td>
                                    <td><?php echo ($job["office"]); ?></td>
                                    <td><?php echo ($job["name"]); ?></td>
                             		<td><?php echo ($job["telephone"]); ?></td>
                             		<td><?php echo ($job["description"]); ?></td>
                                    <td><?php echo (date("Y-m-d H:i:s",$job["time"])); ?></td>
                                    <td>
                                        <div class="btn-group" style="font-size:14px;">
                                       
                                                <a title="查看" href="/tongmeng/admin.php/Job/look/id/<?php echo ($job['id']); ?>" class="btn btn-small"><i class="icon-pencil"></i></a>

                                                <a title="删除" href="/tongmeng/admin.php/Job/del/id/<?php echo ($job['id']); ?>" class="btn btn-small delete" ><i class="icon-trash"></i>
                                                </a>
