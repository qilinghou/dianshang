             ...
             <div class="mws-panel grid_8 mws-collapsible">
                    ...
                    <div class="mws-panel-body no-padding dataTables_wrapper" style="background: none repeat scroll 0 0 #444444;">
                        <table class="mws-table mws-datatable">
                            ...
                            <tbody>
                                <?php if(is_array($goods)): foreach($goods as $key=>$data): ?><tr>
                                    <td name="id"><?php echo ($data['id']); ?></td> 
                                    <td name="tid"><?php echo ($data['tid']); ?></td>
                                    <td name="goodsname"><?php echo ($data['goodsname']); ?></td>
                                    <td name="price"><?php echo ($data['price']); ?>元</td>
                                    <td name="salesnum"><?php echo ($data['salesnum']); ?></td>
                                    <td name="stock"><?php echo ($data['stock']); ?></td>
                                    <td name="comment"><?php echo ($data['comment']); ?></td>
                                    <td name="goodsdesc"><?php echo ($data['goodsdesc']); ?></td>
                                    <td name="cupon"><?php echo ($data['cupon']); ?></td>
                                    <td name="goodspic">
                                        <div style="width:60px; height:55px; border:1px solid green">
                                             <img src="/tongmeng/Public/<?php echo ($data['goodspic']); ?>"/>
                                        </div> 
                                    </td>
                                    <td name="status"><?php echo ($data['status']); ?></td>

                        <!--删除功能-->
                                    <td>
                                        <a href="/tongmeng/admin.php/Goods/mod/id/<?php echo ($data['id']); ?>">
                                          <img src="/tongmeng/Public/images/mod.png">
                                        </a>
                                    </td>


                                    <td>
                                      <a href="/tongmeng/admin.php/Goods/del/id/<?php echo ($data['id']); ?>">
                                         <img src="/tongmeng/Public/images/del.png">
                                      </a>
                                    </td>
