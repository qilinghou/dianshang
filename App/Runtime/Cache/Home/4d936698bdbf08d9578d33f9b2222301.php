   ...
   <div style="width:1000px;margin-left:10px;">
    ...
    <table border="1" bordercolor='green' width="98%" align="center">
        ...
        <?php if(is_array($orders)): foreach($orders as $key=>$order): ?><tr align='center'>
                ...
                <td>
                  <a href="<?php echo U('Goods/index',array('id'=>$order['gid']));?>">
                    <font style="font-size:15px;color:red;"><?php echo ($order["good"]); ?></font>
                  </a>
                </td>
                ...
                <td>
                     <?php if($order["ispay"] == 1): ?><a href="<?php echo U('MyOrder/logisticsLook',array('id'=>$order['id']));?>">
                         查看物流</a>
                         <a href="<?php echo U('MyOrder/commentAdd',array('gid'=>$order['gid']));?>">
                         添加评价
                         </a>
                      <?php else: ?>
                        <a href="">
             ...
             <tr align="center"><td colspan='12'><?php echo ($Page); ?></td>
            </tr>
        </tbody>
    </table>
