                    ...
                    <div class="mws-panel-body no-padding dataTables_wrapper" style="background: none repeat scroll 0 0 #444444;">
                        <table class="mws-table mws-datatable">
                            ...
                            <?php if(is_array($users)): foreach($users as $key=>$vo): ?><tr>
                                    ...
                                    <td><a href="<?php echo U('Admin/log',array('id'=>$vo['id']));?>" target="frame">登录日志</a></td>
                                    ...
                                    <td>
                                        <span class="btn-group" style="font-size:14px;">
                                                ...
                                                <a title="点击修改" href="<?php echo U('Admin/mod',array('id'=>$vo['id']));?>" class="btn btn-small"><i class="icon-pencil"></i></a>
                                                <a title="点击删除" href="<?php echo U('Admin/Del',array('id'=>$vo['id']));?>" class="btn btn-small delete" ><i class="icon-trash"></i></a>
