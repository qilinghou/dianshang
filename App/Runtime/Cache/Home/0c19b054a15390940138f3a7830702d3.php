  ...
  <div class="blank"></div>
   <div style="width:1000px;margin-left:10px;">
    ...
    <table border="1" bordercolor='green' width="98%" align="center">
        ...
        <tbody> 
        <?php if(is_array($goodshistroy)): foreach($goodshistroy as $key=>$goodshistroy): ?><tr align='center'>
                <td><?php echo ($goodshistroy["id"]); ?></td>
                <td><a href="<?php echo U('Goods/index',array('id'=>$goodshistroy['gid']));?>"><font style="font-size:15px;color:red;"><?php echo ($goodshistroy["goodsname"]); ?></font></a></td>
                <td><?php echo (date("Y-m-d H:i:s",$goodshistroy["histroytime"])); ?></td>
                <td><a href="<?php echo U('Histroy/histroyDel',array(id=>$goodshistroy['id']));?>">删除</a></td>
