        ...
        <div id="mws-container" class="clearfix">
            ...
            <div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                        <form class="mws-form" action="<?php echo U('Nav/update');?>" method="post" enctype="multipart/form-data">
                                <div class="mws-form-inline">
                                <div class="mws-form-row">
                                    <label class="mws-form-label">导航栏名字:</label>
                                    <div class="mws-form-item"> 
                                        <input type="text" class="small" name="name" value="<?php echo ($nav[0]['name']); ?>"><span></span><p class='error'></p>
                                    </div>
                                </div>
                            ...
                            <div class="mws-form-inline">
                                <div class="mws-form-row">
                                    <label class="mws-form-label">导航栏链接:</label>
                                    <div class="mws-form-item"> 
                                        <input type="text" class="small" name="links" value="<?php echo ($nav[0]['links']); ?>"><span></span><p class='error'></p>
                                    </div>
                                </div>
                            ...
                            <div class="mws-button-row">
                                <input type="hidden" name="id" value="<?php echo ($nav[0]['id']); ?>">
