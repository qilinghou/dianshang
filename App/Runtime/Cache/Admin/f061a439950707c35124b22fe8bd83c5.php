        ...
        <div id="mws-container" class="clearfix">
            ...
            <div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                        <form class="mws-form" action="<?php echo U('Link/update');?>" method="post" enctype="multipart/form-data">
                            <div class="mws-form-inline">
                                <div class="mws-form-row">
                                    <label class="mws-form-label">网站名称:</label>
                                    <div class="mws-form-item">
                                        <input type="text" class="small" name="linkname" class="link_kk" value="<?php echo ($linkto['linkname']); ?>"><span></span><p class='error'></p>
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label class="mws-form-label">网站地址:</label>
                                    <div class="mws-form-item">
                                        <input type="text" class="small" name="links" class="link_kk" value="<?php echo ($linkto['links']); ?>"><span></span><p class='error'></p>
                                    </div>
                                </div>
