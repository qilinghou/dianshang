     ...
     <div class="box_1">
      <div class="userCenterBox">
        <div class="userMenu">
            ...
            <a href="<?php echo U('MyOrder/mycomment');?>"><img src="/tongmeng/Public/Home/Img/u11.gif"> 我的评论</a>
  ...
  <div class="AreaR">
    <div class="box">
     <div class="box_1">
      ...
      <div>&nbsp;&nbsp;
         <a href="<?php echo U('MyOrder/mycomment');?>" style="margin-left:400px;">返回我的评价列表</a>
      </div>  
