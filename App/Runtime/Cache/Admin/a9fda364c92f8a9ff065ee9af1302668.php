        ...
        <div id="mws-container" class="clearfix">
            ...
            <div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                        <form class="mws-form" action="<?php echo U('Logistics/doAdd');?>" method="post">
                            <div class="mws-form-inline">
                                <div class="mws-form-row">
                                    <label class="mws-form-label">订单号:</label>
                                    <div class="mws-form-item">
                                        <input type="text" class="small" name="orderid">
                                    </div>
                                </div>

                                <div class="mws-form-row">
                                    <label class="mws-form-label">运单号:</label>
                                    <div class="mws-form-item">
                                        <input type="text" class="small" name="logid">
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label class="mws-form-label">物流公司名字:</label>
                                    <div class="mws-form-item">
                                        <input type="text" class="small" name="logisticsname">
                                    </div>
                                </div>
                  
                            </div>
                            <div class="mws-button-row">
                                <input type="hidden" name="logisticstime" value="<?php echo time() ?>">
