        ...
        <div id="mws-container" class="clearfix">
            ...
            <div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                        <form class="mws-form" action="<?php echo U('Nav/insert');?>" method="post" enctype="multipart/form-data">
                                <div class="mws-form-inline">
                                <div class="mws-form-row">
                                    <label class="mws-form-label">导航栏名字:</label>
                                    <div class="mws-form-item"> 
                                        <input type="text" class="small" name="name"><span></span><p class='error'></p>
                                    </div>
                                </div>
                            ...
                            <div class="mws-form-inline">
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item"> 
                                        <input type="text" class="small" name="links"><span></span><p class='error'></p>
                                    </div>
                                </div>
