        ...
        <div id="mws-container" class="clearfix">
             ...
             <div class="mws-panel grid_8 mws-collapsible">
                    ...
                    <div class="mws-panel-header">
                        <span><i class="icon-table"></i>物流管理</span>
                    </div>
                    <div class="mws-panel-body no-padding dataTables_wrapper" style="background: none repeat scroll 0 0 #444444;">
                        <table class="mws-table mws-datatable">
                            ...
                            <?php if(is_array($users)): foreach($users as $key=>$vo): ?><tr>
                                    ...
                                    <td><?php echo ($vo["logisticsname"]); ?></td>
                                    <td><?php echo (date("Y-m-d H:i:s",$vo["logisticstime"])); ?></td>
                                    ...
                                    <td>
                                        <span class="btn-group" style="font-size:14px;">
                                                ...
                                                <a title="点击删除" href="<?php echo U('Logistics/delete',array('id'=>$vo['id']));?>" class="btn btn-small delete" ><i class="icon-trash"></i></a>
