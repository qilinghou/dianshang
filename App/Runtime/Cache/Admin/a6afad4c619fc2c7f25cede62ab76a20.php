...
<body>
    ...
    <div id="mws-wrapper">
        ...
        <div id="mws-container" class="clearfix">
           ...
           <!--from提交表单-->  
                        <form class="mws-form" action="/tongmeng/admin.php/Goods/updata" method="post" enctype="multipart/form-data">
                       ...
                       <!--商品名称-->
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <input type="text" class="small" name="goodsname" id="protitle" value="<?php echo ($goods['goodsname']); ?>">
                        ...
                        <!--商品价格-->
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <input type="text" class="small" name="price" id="price" value="<?php echo ($goods['price']); ?>"><span class="good">商品价格不能为空</span>
                                    </div>
                                </div>
                        ...
                        <!--商品销量-->        
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <input type="text" class="small" name="salesnum" id="member" value="<?php echo ($goods['salesnum']); ?>"><span class="good">会员优惠价格不能为空</span>
                                    </div>
                                </div>
                         ...
                         <!--商品库存--> 
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <input type="number" class="small" name="stock" id="goodsnum" value="<?php echo ($goods['stock']); ?>"><span class="good">库存数量不能为空</span>
                                    </div>
                                </div>
                        ...
                        <!--商品评论次数-->
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <input type="number" class="small" name="comment" id="goodsnum" value="<?php echo ($goods['comment']); ?>"><span class="good">库存数量不能为空</span>
                                    </div>
                                </div>
                        ...
                        <!--商品图片-->
                                 ...
                                 <div class="mws-form-row" style="width:50%;">
                                    ...
                                    <div class="mws-form-item">
                                        ...
                                        <input type="file" class="small" name="goodspic" id="proimg" value="<?php echo ($goods['goodspic']); ?>">
                                    </div>
                                </div>
                        ...
                        <!--是否可以使用优惠券-->
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        ...
                                        </select><span class="good">优惠卷设置不能为空</span>
                        ...
                        <!--上架下架-->
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        ...
                                        </select><span class="good">上架设置不能为空</span>
                               ...
                               <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <input type="hidden" class="small" name="tid" id="member" value="<?php echo ($goods['tid']); ?>">
                                    </div>
                                </div>
