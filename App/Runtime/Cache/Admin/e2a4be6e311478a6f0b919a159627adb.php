            ...
            <div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding"  >
                            ...
                            <div class="mws-form-inline"  >
                                <div class="mws-form-row" style="margin-left:20px;">
                                   <div> 应聘者姓名:
                                        <input type="text" class="small" name="name" value="<?php echo ($job['name']); ?>">
                                    </div><br/>
                                    <div>
                                        应聘职位:&nbsp;<input type="text" name="office" value="<?php echo ($job['office']); ?>" >
                                    </div>

                                </div><br/>
                            
                                <div class="mws-form-row" style="margin-left:20px;">
                                    <div>联系电话:&nbsp;<input type="text" name="telephone" value="   <?php echo ($job['telephone']); ?>" >
                                    </div>
                                ...
                                <div class="mws-form-row" style="margin-left:20px;">
                                    ...
                                    自我介绍:<br/>
                                    <textarea name="description" rows='20' cols='100'>		<?php echo ($job['description']); ?>
                                    </textarea>
                                    
                                </div>

                            <div class="mws-button-row" >&nbsp;&nbsp;
                               <a href="<?php echo U('Job/index');?>" style="margin-left:400px;">返回应聘列表</a>
                            </div>
                         </div>
