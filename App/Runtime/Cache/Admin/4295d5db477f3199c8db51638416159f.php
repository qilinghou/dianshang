             ...
             <div class="mws-panel grid_8 mws-collapsible">
                    ...
                    <div class="mws-panel-body no-padding dataTables_wrapper" style="background: none repeat scroll 0 0 #444444;">
                        <table class="mws-table mws-datatable">
                            ...
                            <tbody> 
                            <?php if(is_array($users)): foreach($users as $key=>$user): ?><tr align='center'>
                                    <td><?php echo ($user["id"]); ?></td>
                                    <td>
                                        <a href="<?php echo U('User/look',array(id=>$user['id']));?>">
                                    ...
                                    <td>
                                        <div class="btn-group" style="font-size:14px;">
                                                ...
                                                <a title="修改" href="/tongmeng/admin.php/User/mod/id/<?php echo ($user['id']); ?>" class="btn btn-small"><i class="icon-pencil"></i></a>

                                                <a title="删除" href="/tongmeng/admin.php/User/del/id/<?php echo ($user['id']); ?>" class="btn btn-small delete" ><i class="icon-trash"></i>
                                                </a>
