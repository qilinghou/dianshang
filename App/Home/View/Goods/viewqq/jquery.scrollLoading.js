...
rel=stylesheet><![endif]--><!--[if (!IE)|(gte IE 8.0)]><!--><link href="/404/files/qbase_datauri.css" type=text/css rel=stylesheet><!--<![endif]-->
...
src="/404/files/notfound.gif" width=520>
<P style="FONT-SIZE: 24px; LINE-HEIGHT: 70px">啊~哦~ 您要查看的页面不存在或已删除！</P>
<P style="MARGIN-BOTTOM: 30px">请检查您输入的网址是否正确，或者点击链接继续浏览</P>
<P style="FONT-SIZE: 14px; LINE-HEIGHT: 20px">您可以回到 <A 
href="http://www.kaisenbuy.com/">网站首页</A>^_^</P></DIV></DIV></DIV></SECTION><FOOTER 
class="mod-footer mod-cs-footer">
<DIV class="clearfix hidden-box"></DIV>
<DIV class=footer-box>

<DIV class=copy-box>©2014&nbsp;KaisenBuy.com</DIV></DIV></FOOTER>
