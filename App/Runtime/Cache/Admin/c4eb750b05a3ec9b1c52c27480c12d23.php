...
<body>
    ...
    <!--from提交表单-->    <!--from提交表单-->     
                        <form class="mws-form" action="/tongmeng/admin.php/Goods/insert" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mws-form-inline">
                                <div class="mws-form-inline">
                                    <div class="mws-form-row">
                                        ...
                                        <!--下拉框-->
                                            <select class="small" name='id' id="cid">
                                                <option value="">请选择</option>
                       <!--商品分类-->                                                                        
                                          <!--  <?php if(is_array($goodstype)): foreach($goodstype as $key=>$value): if($value['pid'] == 0 ): ?><option value="<?php echo ($value['id']); ?>"> 
                                                   <?php echo ($value['name']); ?>
                                               </option><?php endif; endforeach; endif; ?>
                                           -->
                                            <?php if(is_array($goodstype)): foreach($goodstype as $key=>$value): ?>$a = $value['npth'];
                                               <?php if($value['pid'] == 0 ): ?><option value="<?php echo ($value['id']); ?>"> 
                                                   <?php echo ($value['name']); ?>
                                            ...
                                            </select><span class="good">商品分类不能为空</span>
                       ...
                       <!--商品品牌-->
                                <div class="mws-form-inline">
                                    <div class="mws-form-row">
                                        ...
                                        <div class="mws-form-item">
                                        <!--下拉框-->
                                            <select class="small" name='npth' id="brandid">
                                                <option value="">请选择</option>
                                            ...
                                            <?php if(is_array($goodstype)): foreach($goodstype as $key=>$value): if($value['pid'] != 0 ): ?><option value="<?php echo ($value['id']); ?>"> 
                                             ...
                                             <span class="good" id="brand">所属品牌不能为空</span>
                                        </div>
                                    </div>
                       ...
                       <!--商品名称-->
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <input type="text" class="small" name="" id="protitle" value="<?php echo ($value['goodsname']); ?>">
                        ...
                        <!--商品价格-->
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <input type="text" class="small" name="" id="price" value="<?php echo ($goodsInfo['price']); ?>"><span class="good">商品价格不能为空</span>
                                    </div>
                                </div>
                        <!--商品销量-->        
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <input type="text" class="small" name="" id="member" value="<?php echo ($goodsInfo['member']); ?>"><span class="good">会员优惠价格不能为空</span>
                                    </div>
                                </div>
                                ...
                                <!-- <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <input type="number" class="small" name="prohots" id="prohots" value="<?php echo ($goodsInfo['prohots']); ?>"><span class="good">商品积分不能为空</span>
                                    </div>
                                </div> -->
                         ...
                         <!--商品库存--> 
                                <div class="mws-form-row">
                                    <label class="mws-form-label">商品库存:</label>
                                    <div class="mws-form-item">
                                        <input type="number" class="small" name="" id="goodsnum" value="<?php echo ($goodsInfo['goodsnum']); ?>"><span class="good">库存数量不能为空</span>
                                    </div>
                                </div>
                        <!--商品评论次数-->
                                <div class="mws-form-row">
                        ...
                        <!--商品描述-->
                              <div class="mws-form-row">
                                   ...
                                   <div class="mws-form-item">
                                          <script id="editor" type="text/plain" style="width:800px;height:80px;" name = "">
                        ...
                        <!--商品图片-->
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <input type="text" class="small" name="" id="description" value="<?php echo ($goodsInfo['description']); ?>"><span class="good">商品描述不能为空</span>
                                    </div>
                                </div>
                                ...
                                <!-- <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <input type="text" class="small" name="keywords" id="keywords" value="<?php echo ($goodsInfo['keywords']); ?>"><span class="good">商品关键字不能为空</span>
                                    </div>
                                </div> -->
                        ...
                        <!--是否可以使用优惠券-->
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <select class="small" name='' id="hgoods">
                                                <option value="0">请选择</option>
                                                <option value="1" <?php if($goodsInfo['hgoods'] == 1 ): ?>selected<?php endif; ?>>可以</option>
                                                <option value="2"  <?php if($goodsInfo['hgoods'] == 2 ): ?>selected<?php endif; ?>>不可以</option>
                                ...
                                <!-- <div class="mws-form-row">
                                    <label class="mws-form-label">是否为推荐商品:</label>
                                    <div class="mws-form-item">
                                        <select class="small" name='recommend' id="recommend">
                                                <option value="0">请选择</option>
                                                <option value="1"  <?php if($goodsInfo['recommend'] == 1 ): ?>selected<?php endif; ?>>√</option>
                                                <option value="2"  <?php if($goodsInfo['recommend'] == 2 ): ?>selected<?php endif; ?>>×</option>
                                        </select><span class="good">推荐商品设置不能为空</span>
                                    </div>
                                </div>
                                ...
                                <div class="mws-form-row" style="width:50%;">
                                    ...
                                    <div class="mws-form-item">
                                        ...
                                        <input type="file" class="small" name="proimg" id="proimg">
                                    </div>
                                </div> -->
                            ...
                            <div class="mws-button-row">
                                <input type="hidden" name="" value="<?php echo ($_GET['id']); ?>">
