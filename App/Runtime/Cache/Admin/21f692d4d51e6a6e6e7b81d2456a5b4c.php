        ...
        <div id="mws-container" class="clearfix">
            ...
            <div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                        <form class="mws-form" action="<?php echo U('Feedback/doreply');?>" method="post" enctype="multipart/form-data">
                                <div class="mws-form-inline">
                                <div class="mws-form-row">
                                    <label class="mws-form-label">反馈ID:</label>
                                 <div><?php echo ($fid); ?></div>
                                </div>
                            ...
                            <div class="mws-form-inline">
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item"> 
                                        <textarea name="replycontent"></textarea><p class='error'></p>
                                    </div>
                                </div>
                            ...
                            <div class="mws-button-row">
                                ...
                                <input type="hidden" name="replytime" value="<?php echo time() ?>">
