    ...
    <div class="box">
     <div class="box_1">
      <div class="userCenterBox boxCenterList clearfix" style="_height:1%;">
          ...
          <div class="blank"></div>
            <div class="blank"></div>
          <form action="<?php echo U('Feekback/feekbackInsert');?>" method="post" name="formMsg" onSubmit="return submitMsg()">
                  <table width="100%" border="0" cellpadding="3">
                    
                    <tr >
                      <td align="right">主题：</td>
                      <td><input name="feekbacktitle" type="text" size="30" class="inputBg" style="width:90%;"/></td>
                    </tr>
                    <tr>
                      <td align="right" valign="top">反馈内容：</td>
                      <td>
                        <textarea name="feekbackcontent" cols="100" rows="50" wrap="virtual" class="B_blue" style="width:90%;height:300px"></textarea>
                      </td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
