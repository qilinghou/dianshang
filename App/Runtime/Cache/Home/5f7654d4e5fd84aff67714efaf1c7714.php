    ...
    <div class="box">
     <div class="box_1">
      <div class="userCenterBox boxCenterList clearfix" style="_height:1%;">
        <h5><span>我的充值历史列表</span><a href="<?php echo U('Recharge/rechargeAdd');?>"><b>我要充值</b></a></h5>
    <div class="blank"></div>
  ...
  <div class="blank"></div>
   <div style="width:1000px;margin-left:10px;">
    ...
    <table border="1" bordercolor='green' width="98%" align="center">
        ...
        <tbody> 
        <?php if(is_array($recharge)): foreach($recharge as $key=>$recharge): ?><tr align='center'>
                <td><?php echo ($recharge["id"]); ?></td>
                <td><?php echo ($_SESSION['userdetail'][0]['name']); ?></td>
                <td><?php echo ($recharge["rechargemoney"]); ?></td>
                <td><?php echo (date("Y-m-d H:i:s",$recharge["rechargetime"])); ?></td>
                <td><a href="<?php echo U('Recharge/rechargeDel',array(id=>$recharge['id']));?>">删除</a></td>
