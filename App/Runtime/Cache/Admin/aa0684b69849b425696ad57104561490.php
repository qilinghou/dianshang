             ...
             <div class="mws-panel grid_8 mws-collapsible">
                    ...
                    <div class="mws-panel-body no-padding dataTables_wrapper" style="background: none repeat scroll 0 0 #444444;">
                        <table class="mws-table mws-datatable">
                            ...
                            <tbody>
                                <?php if(is_array($cates)): foreach($cates as $key=>$vo): ?><tr>
                                    <td class="ids"><?php echo ($vo['id']); ?></td>
                                    <td><?php echo ($vo['name']); ?></td>
                                    <td class="p"><?php echo ($vo['links']); ?></td>
                                  
                                    <td>
                                        <span class="btn-group">
                                            <a href="<?php echo U('Nav/edit',array('id'=>$vo['id']));?>" class="btn btn-small"><i class="icon-pencil"></i></a>
                                             <a title="点击删除" href="<?php echo U('Nav/del',array('id'=>$vo['id']));?>" class="btn btn-small delete" ><i class="icon-trash"></i></a>
                                         </span>
                                    </td>
