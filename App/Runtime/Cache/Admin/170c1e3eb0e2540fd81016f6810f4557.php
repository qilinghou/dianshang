        ...
        <div id="mws-container" class="clearfix" style="margin-left:-10px">
            ...
            <div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                        <form class="mws-form" action="/tongmeng/admin.php/Help/update" method="post">
                            <div class="mws-form-inline">
                                <div class="mws-form-row">
                                    <label class="mws-form-label"> 帮助主题:</label>
                                    <div class="mws-form-item">
                                        <input type="text" class="small" name="title" value="<?php echo ($help['title']); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <textarea name="content"  cols=100 rows = 100 ><?php echo ($help['content']); ?></textarea>
                                    </div>
                                </div>
