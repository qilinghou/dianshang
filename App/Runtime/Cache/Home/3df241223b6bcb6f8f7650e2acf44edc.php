    ...
    <div class="box">
     <div class="box_1">
      <div class="userCenterBox boxCenterList clearfix" style="_height:1%;">
           ...
           <h5><span>我的反馈</span> <a href="<?php echo U('User/feekbackadd');?>">添加反馈</a></h5>
                            ...
                            <?php if(is_array($feekback)): foreach($feekback as $key=>$feekback): ?><tr align='center'>
                                    ...
                                    <td>
                                        <div  style="font-size:14px;">
                                                 <a title="查看回复" href="/tongmeng/index.php/User/reply/fid/<?php echo ($feekback['id']); ?>">查看回复
                                                </a>&nbsp;&nbsp;
                                                <a title="删除" href="/tongmeng/index.php/User/feekbackdel/id/<?php echo ($feekback['id']); ?>">删除
                                                </a>
