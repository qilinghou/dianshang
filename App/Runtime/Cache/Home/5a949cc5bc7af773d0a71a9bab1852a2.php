     ...
     <div class="box_1">
      <div class="userCenterBox">
        <div class="userMenu">
            ...
            <a href="<?php echo U('User/myorder');?>"><img src="/tongmeng/Public/Home/Img/u3.gif"> 我的订单</a>
            <a href="<?php echo U('User/mycomment');?>"><img src="/tongmeng/Public/Home/Img/u11.gif"> 我的评论</a>
            <a href="<?php echo U('User/mycollect');?>"><img src="/tongmeng/Public/Home/Img/u5.gif"> 我的收藏</a>
            <a href="<?php echo U('User/myfeekback');?>"><img src="/tongmeng/Public/Home/Img/u6.gif"> 我的反馈</a>
            <a href="<?php echo U('User/logisticslook');?>"><img src="/tongmeng/Public/Home/Img/u12.gif">物流跟踪</a>
            <a href="<?php echo U('User/recharge');?>"><img src="/tongmeng/Public/Home/Img/u13.gif">充值历史</a>
    ...
    <div class="box">
     <div class="box_1">
      <div class="userCenterBox boxCenterList clearfix" style="_height:1%;">
           ...
           <h5><span>我的反馈</span></h5>
          <div class="blank"></div>
            <div class="blank"></div>
          <form action="<?php echo U('User/feekbackinsert');?>" method="post" name="formMsg" onSubmit="return submitMsg()">
                  <table width="100%" border="0" cellpadding="3">
                    
                    <tr>
                      <td align="right">主题：</td>
                      <td><input name="feekbacktitle" type="text" size="30" class="inputBg" /></td>
                    </tr>
                    <tr>
                      <td align="right" valign="top">反馈内容：</td>
                      <td>
                        <textarea name="feekbackcontent" cols="100" rows="50" wrap="virtual" class="B_blue"></textarea>
                      </td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>
                        <input type="hidden"  name="feekbacktime" value="<?php echo time() ?>"/>
