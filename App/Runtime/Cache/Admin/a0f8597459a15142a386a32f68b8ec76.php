            ...
            <div id="mws-navigation">
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            <li><a href="<?php echo U('Goods/add');?>" target="frame">添加新商品</a></li>
                            <li><a href="<?php echo U('Goods/index');?>" target="frame">商品列表</a></li>
                            <li><a href="<?php echo U('Cate/add');?>" target="frame">添加商品分类</a></li>
                            <li><a href="<?php echo U('Cate/index');?>" target="frame">商品分类</a></li>    
                            <li><a href="<?php echo U('Brand/add');?>"  target="frame">添加商品品牌</a></li>
                            <li><a href="<?php echo U('Brand/index');?>"  target="frame">商品品牌</a></li>
                            <li><a href="<?php echo U('Recycle/index');?>"  target="frame">商品回收站</a></li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                     ...
                     <li>
                        ...
                        <ul>
                            ...
                            <li><a href="<?php echo U('Replay/index');?>" target="frame">回复列表</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="icon-list"></i>权限管理</a>
                        <ul>
                            <li><a href="<?php echo U('User/Index');?>" target="frame">管理员列表</a></li>
                            
                            <li><a href="<?php echo U('User/Add');?>" target="frame">添加管理员</a></li>
