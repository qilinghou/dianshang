     ...
     <div class="box_1">
      <div class="userCenterBox">
        <div class="userMenu">
            ...
            <a href="<?php echo U('User/personal');?>"><img src="/tongmeng/Public/Home/Img/u2.gif">个人资料修改</a>
  ...
  <div class="AreaR">
    <div class="box">
     <div class="box_1">
      ...
      <div class="blank"></div>
           <form action="<?php echo U('User/personal');?>" method="post" enctype="multipart/form-data" align="center" >
                            <div >
                                ...
                                <div style="margin-left:200px;" id="extend_field5i">
                                    手机号码:&nbsp;
