...
<!--类型1-->
         ...
         <ul style="background-color:grey;">
          ...
          <li onclick="doClick(this)" class="menu" >电动玩具
      
              <ol class="olbg">
                  <?php if(is_array($goodstypes)): foreach($goodstypes as $key=>$data): if($data['pid'] == 1): ?><a class="alinks" href="/tongmeng/index.php/Viewgoods/index/id/<?php echo ($data['id']); ?>">
           ...
           <li onclick="doClick(this)" class="menu">遥控玩具
      
              <ol class="olbg">
                  <?php if(is_array($goodstypes)): foreach($goodstypes as $key=>$data): if($data['pid'] == 2): ?><a class="alinks" href="/tongmeng/index.php/Viewgoods/index/id/<?php echo ($data['id']); ?>">
                  <li class="listyle"><?php echo ($data['name']); ?></li>
                  </a><?php endif; endforeach; endif; ?>
              </ol>
          </li>

          </li><li onclick="doClick(this)" class="menu">毛绒玩具
      
              <ol class="olbg">
                  <?php if(is_array($goodstypes)): foreach($goodstypes as $key=>$data): if($data['pid'] == 3): ?><a class="alinks" href="/tongmeng/index.php/Viewgoods/index/id/<?php echo ($data['id']); ?>">
                  <li class="listyle"><?php echo ($data['name']); ?></li>
                  </a><?php endif; endforeach; endif; ?>
              </ol>
          </li>
           ...
           <li onclick="doClick(this)" class="menu">益智玩具
      
              <ol class="olbg">
                  <?php if(is_array($goodstypes)): foreach($goodstypes as $key=>$data): if($data['pid'] == 4): ?><a class="alinks" href="/tongmeng/index.php/Viewgoods/index/id/<?php echo ($data['id']); ?>">
                  <li class="listyle"><?php echo ($data['name']); ?></li>
                  </a><?php endif; endforeach; endif; ?>
              </ol>
          </li>
          ...
          <li onclick="doClick(this)" class="menu">婴幼儿玩具
      
              <ol class="olbg">
                  <?php if(is_array($goodstypes)): foreach($goodstypes as $key=>$data): if($data['pid'] == 5): ?><a class="alinks" href="/tongmeng/index.php/Viewgoods/index/id/<?php echo ($data['id']); ?>">
                  <li class="listyle"><?php echo ($data['name']); ?></li>
                  </a><?php endif; endforeach; endif; ?>
              </ol>
          </li>
...
<!--循环--><?php endforeach; endif; ?>
 ...
 <form name="selectPageForm" action="" method="get">
      ...
      <!--  <span class="paixu_page">
       ...
       <a href="<?php echo ($page); ?>">下一页</a>
       <a href="<?php echo ($list); ?>">最末页</a></span> -->
