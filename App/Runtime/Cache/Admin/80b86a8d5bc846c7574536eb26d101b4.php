                        ...
                        <form class="mws-form" action="/tongmeng/admin.php/Advertising/insert" method="post" enctype="multipart/form-data">
                            <div class="mws-form-inline">
                              ...
                              <div class="mws-form-row">
                                 ...
                                 <div class="mws-form-item">
                                     <div width='300px' height='300px'style='border:1px solid green' class="small">
                                     <img src="/tongmeng/Public/<?php echo ($advertising[0]['img']); ?>"/>
                                     </div>
                                 </div>
                             </div> 
                            ...
                            <textarea class="small" name="content"><?php echo ($advertising[0]['content']); ?></textarea>
                                    </div>
                                </div>
                            </div>
