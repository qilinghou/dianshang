  ...
  <div class="AreaR">
    <div class="box">
     <div class="box_1">
      ...
      <h5><span>添加评价</span></h5>
       <div class="blank"></div>
        <form action="<?php echo U('MyOrder/commentinsert');?>" method="post">
           <div >                                                         
              <center><b>评价内容</b></center>
              <textarea name="commentcontent" rows='20' cols='100' style="width:100%;height:200px;">
              </textarea>                     
          </div>
          <div >  
            <input type="hidden" name="gid" value="<?php echo ($gid); ?>">                            
            <input type="hidden" name="commenttime" value="<?php echo time() ?>">                            
            <center> 
      ...
      <div>&nbsp;&nbsp;
         <a href="<?php echo U('MyOrder/myorder');?>" style="margin-left:400px;">返回我的订单列表</a>
      </div>  
