     ...
     <div class="box_1">
      <div class="userCenterBox">
        <div class="userMenu">
            ...
            <a href="<?php echo U('User/myfeedback');?>"><img src="/tongmeng/Public/Home/Img/u6.gif"> 我的反馈</a>
    ...
    <div class="box">
     <div class="box_1">
      <div class="userCenterBox boxCenterList clearfix" style="_height:1%;">
           ...
           <h5><span>我的反馈</span> <a href="<?php echo U('User/feedbackadd');?>">添加反馈</a></h5>
          <div></div>
            <div class="blank"></div>
                    ...
                    <div>
                        <table border='0' width="100%" >
                            ...
                            <?php if(is_array($feekback)): foreach($feekback as $key=>$feekback): ?><tr align='center'>
                                    ...
                                    <td>
                                        <a href="<?php echo U('User/feekbacklook',array(id=>$user['id']));?>"><?php echo ($feekback["feekbacktitle"]); ?></a>
                                    </td>
                                    <td><?php echo ($feekback["feekbackcontent"]); ?></td>
                                    <td><?php echo ($t); ?></td>
                                    <td>
                                        <div  style="font-size:14px;">
                                                <a title="删除" href="/tongmeng/index.php/User/feekbackdel/id/<?php echo ($feekback['id']); ?>" 
                                                </a>
